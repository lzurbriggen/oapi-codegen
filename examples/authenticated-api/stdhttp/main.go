...
import (
	...
	"github.com/lzurbriggen/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/lzurbriggen/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)
