...
import (
	...
	"github.com/lzurbriggen/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/lzurbriggen/oapi-codegen/v2/examples/authenticated-api/echo/server"
)
